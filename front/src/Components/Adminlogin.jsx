...
const Adminlogin = () => {
  return (
    <div className='text-black h-[100vh] w-[100%] flex justify-center items-center bg-cover' style={{ backgroundImage: "url('../src/assets/yellow.jpg')" }}>
    <div className='w-full h-screen backdrop-filter backdrop-blur-xl flex justify-center items-center'>
      <div className='bg-slate- border border-slate-400 rounded-xl p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-20 relative'>
        ...
        <form>
          ...
          <div>
            <span className='m-9'>New Here? <Link to="/aregister" className='text-blue-950'> Create an account</Link></span>
          </div>
        </form>
      </div>
    </div>
