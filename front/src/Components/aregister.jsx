...
const aregister = () => {
  ...
  return (
    <div className='text-white h-[100vh] w-[100%]  flex justify-center items-center bg-cover  ' style={{"backgroundImage":"url('../src/assets/yellow.jpg')"}}>
    ...
    <div className='bg-slate- border border-slate-400 rounded-xl p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-20 relative'>
      ...
      <div>
        <span className='m-9'>Already have an Account? <Link to="/admlogin" className='text-blue-950'> Login</Link></span>
      </div>
